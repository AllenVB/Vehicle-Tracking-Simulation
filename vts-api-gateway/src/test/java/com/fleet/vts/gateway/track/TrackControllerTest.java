...
/**
 * The public phone-tracker ingress forwards each GPS fix verbatim to ingestion's batch
 * endpoint (as a one-element array), carrying the real speed and GPS accuracy through.
 */
class TrackControllerTest {
    ...
    void forwardsFixToIngestionBatchAsSingletonArray() {
        ...
        TrackController controller = new TrackController(builder.build());
        ...
        controller.ingest(new TrackRequest(
